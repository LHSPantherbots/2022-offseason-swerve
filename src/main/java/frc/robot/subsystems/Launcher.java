...
public class Launcher extends SubsystemBase{
    ...
    CANSparkMax launcherLeader = new CANSparkMax(RIO_Channels_CAN_MOTOR.LAUNCH_LEADER, MotorType.kBrushless);
    CANSparkMax launcherFollower = new CANSparkMax(RIO_Channels_CAN_MOTOR.LAUNCH_FOLLOWER, MotorType.kBrushless);
    CANSparkMax topRoller = new CANSparkMax(RIO_Channels_CAN_MOTOR.LAUNCH_TOPROLLER, MotorType.kBrushless);
